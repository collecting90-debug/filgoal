...
from src.scraper.filgoal_parser_v2 import FilGoalParser, ParsedArticle

FILGOAL_ARTICLES_URL = "https://www.filgoal.com/articles"
...
class RealTimeMonitor:
    ...
    async def run_forever(self):
        ...
        logger.info(f"RealTimeMonitor started — polling every {POLL_INTERVAL}s")
    ...
    def _extract_urls_from_html(self, html: str) -> list[str]:
        ...
        for a in soup.find_all("a", href=True):
            ...
            if "/articles/" in href and href.count("/") >= 3:
                full_url = href if href.startswith("http") else f"https://www.filgoal.com{href}"
