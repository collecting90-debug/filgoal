...
class Settings(BaseSettings):
    ...
    # ── Telegram ─────────────────────────────────────────────────────────────
    telegram_bot_token_filgoal: str
    telegram_chat_id_filgoal: str

    @property
    def effective_telegram_bot_token(self) -> str:
        return self.telegram_bot_token_filgoal

    @property
    def effective_telegram_chat_id(self) -> str:
        return self.telegram_chat_id_filgoal
    ...
    # ── FilGoal subcategories ─────────────────────────────────────────────────
    @property
    def subcategories(self) -> list[dict]:
        return [
            {"name": "أخبار كرة القدم", "url": "https://www.filgoal.com/articles"},
        ]
